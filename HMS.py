...
class Hospital:
    def __init__(self,root):
        ...
        lbltitle = Label(self.root,bd=20,relief = RIDGE ,text="+ HEALTH CARE - MEDICAL HUB",fg="red",bg="white",font=("times new roman",50,"bold"))
        ...
        comNametablet["values"]=("","Crocin","Azithromicin","Vicks action","Dolo-650","Dexon","Azax-500","Ascroll","Doxycycline","Amlodipine")
        ...
        #---------------Buttons------------------------------
        btnPrescription=Button(Buttonframe,text="Prescription",command=self.Prescription,fg="white",bg="green",font=("arial",8,"bold"),width=34,height=2,padx=2)
        btnPrescription.grid(row=0,column=0)

        btnPrescriptionData = Button(Buttonframe, text="Prescription Data",command=self.iPrescriptionData, fg="white", bg="green", font=("arial", 8, "bold"),
                                 width=34, height=2, padx=2)
        btnPrescriptionData.grid(row=0, column=1)

        btnUpdate = Button(Buttonframe, text="Update",command=self.update, fg="white", bg="green", font=("arial", 8, "bold"),
                                 width=34, height=2, padx=2)
        btnUpdate.grid(row=0, column=2)

        btnClear = Button(Buttonframe, text="Delete",command=self.delete, fg="white", bg="green", font=("arial", 8, "bold"),
                           width=34, height=2, padx=2)
        btnClear.grid(row=0, column=3)

        btnExit = Button(Buttonframe, text="Clear",command=self.clear, fg="white", bg="green", font=("arial", 8, "bold"),
                          width=34, height=2, padx=2)
        btnExit.grid(row=0, column=4)

        btnExit = Button(Buttonframe, text="Exit",command=self.exit, fg="white", bg="green", font=("arial", 8, "bold"),
                         width=34, height=2, padx=2)
    ...
    def iPrescriptionData(self):
        if self.Nameoftablets.get() == "" or self.ref.get() == "" :
            ...
            conn = sql.connect(host="localhost", user="root", password="Kb@682005", database="hospitaldata")
